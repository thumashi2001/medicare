  ...
  const cards = [
    {
      ...
      description: "Update your doctor profile, specialization, and consultation details.",
      action: () => navigate("/doctor/profile")
    },
    {
      title: "Availability Schedule",
      description: "Manage the time slots when patients can book you.",
      action: () => navigate("/doctor/availability")
    },
    {
      title: "Digital Prescriptions",
      description: "Create and review prescriptions for your patients.",
    ...
    <div>
      <div style={styles.heroCard}>
        ...
        <p style={styles.subtitle}>
          Manage your profile, availability, prescriptions, and appointment requests from one
          place.
        </p>
      </div>

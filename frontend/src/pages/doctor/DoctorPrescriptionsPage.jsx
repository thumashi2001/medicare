...
export default function DoctorPrescriptionsPage() {
  ...
  const fetchPrescriptions = async () => {
    ...
    try {
      const response = await axios.get(`${DOCTOR_API}/api/doctors/prescriptions`, {
        headers: authHeaders
      });
    ...
    <div style={styles.wrapper}>
      <div style={styles.headerCard}>
        ...
        <p style={styles.headerText}>
          Create prescriptions for patients and review your recently issued records.
        </p>
      </div>
      ...
      <div style={styles.card}>
        ...
        <form onSubmit={handleSubmit} style={styles.formGrid}>
          ...
          <div style={styles.fieldFull}>
            ...
            <button type="button" onClick={addMedicineRow} style={styles.secondaryButton}>
              Add Medicine
            </button>
          </div>
              ...
              <div key={prescription._id} style={styles.prescriptionCard}>
                ...
                <div style={styles.medicineBlock}>
                  {prescription.medicines.map((medicine) => (
                    <div key={medicine._id} style={styles.medicineItem}>

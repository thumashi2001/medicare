...
exports.getRecentActivities = async (req, res) => {
    try {
        res.json([
            { title: "New user registered", description: "saman@gmail.com • 2 minutes ago" },
            { title: "Doctor verification submitted", description: "Dr. Nuwan Perera • 15 minutes ago" },
            { title: "Payment received", description: "Rs. 3500.00 • 1 hour ago" }
        ]);
    } catch (error) {
        res.status(500).json({ message: error.message });
    }
